...
if __name__ == "__main__":
    ...
    # Web interfeysni alohida oqimda ishga tushurish
    def start_flask():
        app.run(host='0.0.0.0', port=5000)

    # Tarmoq paketlarini bloklashni alohida oqimda ishga tushurish
    def start_packet_blocking():
        block_packets()

    # Flask ilovasini alohida oqimda ishga tushirish
    Thread(target=start_flask).start()

    # Paketlarni bloklashni alohida oqimda ishga tushirish
    Thread(target=start_packet_blocking).start()
